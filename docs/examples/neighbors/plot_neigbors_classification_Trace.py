# -*- coding: utf-8 -*-
"""
Nearest Neighbors Classification (Trace Dataset)
===================================================
...
of different distance metrics as model parameters on the `Trace` time series dataset .
...
# ----------------
#
# In this example we use the `Trace dataset from the UCR/UEA archive
# <https://www.timeseriesclassification.com/description.php?Dataset=Trace>`_ .
#
# TODO explain the dataset
#
...
# This confirms that accounting for temporal distortion is beneficial for the `Trace`
# dataset where TODO explain why the DTW metric is better than the others.
#
