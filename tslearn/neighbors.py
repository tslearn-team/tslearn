...
class NearestNeighborsDynamicTimeWarping(NearestNeighbors):
    """Unsupervised learner for implementing neighbor searches using Dynamic Time Warping 
    as the core metric."""
...
class KNeighborsDynamicTimeWarpingClassifier(KNeighborsClassifier):
    """Classifier implementing the k-nearest neighbors vote with Dynamic Time Warping as 
    its core metric."""
...
class KNeighborsDynamicTimeWarpingRegressor(KNeighborsRegressor):
    """Regression based on k-nearest neighbors with Dynamic Time Warping as the core 
    metric."""
    def __init__(self, n_neighbors=5, weights='uniform', **kwargs):
...
class RadiusNeighborsDynamicTimeWarpingRegressor(RadiusNeighborsRegressor):
    """Regression based on neighbors within a fixed radius with Dynamic Time Warping as 
    the core metric."""
