...
class SupervisedTimeSeriesKMeans(TimeSeriesKMeans):
    """Supervised K-means clustering for time-series data.
    ...
    def fit_predict(self, X, y):
        """Fit supervised k-means clustering using X and y and then predict the closest cluster each time series in X belongs to.
        This overrides TimeSeriesKMeans.fit_predict(X, y=None) to disallow passing no labels.
        It is more efficient to use this method than to sequentially call fit and predict.
